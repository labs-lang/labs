...
/* mpor auxiliary control variables */
#define __cs_R_ACCESS 2
#define __cs_W_ACCESS 1
<insert-global-var-copies-here>

#define __cs_DEP 1
#define __cs_NOTRANS 0
#define __cs_NODEP -1
__CPROVER_bitvector[2] __DC[THREADS+1][THREADS+1];
unsigned __CPROVER_bitvector[1] __access_RW[THREADS+1];
